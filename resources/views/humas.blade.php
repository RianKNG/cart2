...
<body>
  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <h1 class="logo"><a href="#hero"><img src="asset/img/favicon.png" class="img-fluid animated" alt="">&nbsp;PERUMDA</a></h1>
        ...
        <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="150">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            ...
            {{-- <div class="portfolio-info">
              <h4>App 1</h4>
              <p>App</p>
              <a href="asset/img/portfolio/portfolio-1.jpeg" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="App 1"><i class="bx bx-plus"></i></a>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-web">
            ...
            {{-- <div class="portfolio-info">
              <h4>Web 3</h4>
              <p>Web</p>
              <a href="asset/img/portfolio/portfolio-2.jpeg" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="Web 3"><i class="bx bx-plus"></i></a>
              <a href="portfolio-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
            </div> --}}
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            ...
            {{-- <div class="portfolio-info">
              <h4>App 2</h4>
              <p>App</p>
              <a href="asset/img/portfolio/portfolio-3.jpeg" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="App 2"><i class="bx bx-plus"></i></a>
              <a href="portfolio-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
            </div> --}}
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            ...
            {{-- <div class="portfolio-info">
              <h4>Card 2</h4>
              <p>Card</p>
              <a href="asset/img/portfolio/portfolio-4.jpeg" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="Card 2"><i class="bx bx-plus"></i></a>
              <a href="portfolio-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
            </div> --}}
          </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in">
            <div class="member">
              <img src="asset/img/team/team-1.jpeg" alt="">
              <h4>Ibu Icih</h4>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in">
            <div class="member">
              <img src="asset/img/team/team-2.jpeg" alt="">
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in">
            <div class="member">
              <img src="asset/img/team/team-3.jpeg" alt="">
              <h4>Ipang S.Kom</h4>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in">
            <div class="member">
              <img src="asset/img/team/team-4.jpeg" alt="">
              <h4>Sri.SE</h4>
              <span>Staff Senior</span>
              <p>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in">
            <div class="member">
              <img src="asset/img/team/team-5.jpeg" alt="">
              <h4>Ido. SE</h4>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in">
            <div class="member">
              <img src="asset/img/team/team-6.jpeg" alt="">
              <h4>Meli.SE</h4>
              <span>Staff Senior</span>
              <p>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in">
            <div class="member">
              <img src="asset/img/team/team-7.jpeg" alt="">
              <h4>Rian Riansah</h4>
              <span>Staff</span>
              <p>
